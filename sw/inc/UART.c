...
// Clear display
void Output_Clear1(void){ // Clears the display
  // not implemented on the UART
}
// Turn off display (low power)
void Output_Off1(void){   // Turns off the display
  // not implemented on the UART
}
// Turn on display
void Output_On1(void){    // Turns on the display
  // not implemented on the UART
}
// set the color for future output
void Output_Color1(uint32_t newColor){ // Set color of future output 
  // not implemented on the UART
}
